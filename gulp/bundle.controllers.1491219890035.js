    ...
    $scope.Submit = function () {
        ...
        angular.forEach($scope.goallists, function (goallist) {
            if (goallist.isUpdated) {
                ...
                dataListToUpdate.push({
                    state: "set",
                    sip: parseInt(goallist.sip),
                    lumpsum: parseInt(goallist.lumpsum),
                    _goalid: goallist._goalid,
                    netScore: goallist.netScore,
                    type: goallist.type
                });
            }
        });
...
function goalPortfolioDashboardCtrl($scope, $state, $http, c3ChartService, thousandSeparator, toaster) {
    ...
    function showAMCChart() {
        ...
        for (var i in $scope.fundAll) {
            ...
            $scope.gridData.push({
                Type: goalType,
                Category: $scope.fundAll[i].category,
