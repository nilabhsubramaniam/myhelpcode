...
function clientsCtrl($scope, $http, toaster, uiGridConstants, $rootScope, fintaxService, fintaxFilingService) {
    ...
    $scope.gridOptions.columnDefs = [
        {name: 'Name', field: 'fullName', pinnedLeft: true},
        {name: 'Last Login', field : 'last'},
        {name: 'Account Status', field: 'acctStatus'},
        {
            name: 'Category',
            "field": "category",
            width: '15%',
            ...
            filter: {
                ...
                selectOptions: [ { value: '1', label: 'unassigned' }, { value: '2', label: 'prospect-followup' }, { value: '3', label: 'prospect-newsletter'}, { value: '4', label: 'client-underprocess' },{ value: '5', label: 'client-active' }]
            },
        ...
        },
        {
            ...
            filter: {
                type: uiGridConstants.filter.SELECT,
                selectOptions: [ { value: '1', label: 'Neeti' }, { value: '2', label: 'Saurabh' }, { value: '3', label: 'Subhajit'}, { value: '4', label: 'Megha' }, {value: '5', label: 'Operations'}]
            },
    ...
    $http({
        ...
        response.data.forEach(function (user) {
            user.last = moment(user.createdAt).format('DD-MMM-YY, h:mm:ss a');
...
function filingSalaryIncomeCtrl($scope, $state, fintaxFilingService, fintaxService, convertDigitsIntoWords, ModalService, toaster) {
    $scope.salaryFormData = {
        ...
        prevEmploymentDetails: [{
            PrevEmployer: '',
            PrevEmploymentFromDate: startFiscalYear(),
            PrevEmploymentEndDate: endFiscalYear()
        }]
    };
        ...
        fintaxFilingService.getInfo('salary').then(function (response) {
            if (response != null && response.salary !== undefined && response.salary.salaried != undefined) {
                ...
                fintaxService.getBasicInfo().then(function (response) {
                    ...
                    $scope.salaryFormData.employmentFromDate = startFiscalYear();
                    $scope.salaryFormData.employmentEndDate = endFiscalYear();
                });
            }
        }, function (reason) {
            console.log(reason);
...
function reportCtrl($scope, $http) {
    ...
    $scope.gridOptions.columnDefs = [
        ...
        {name: 'Source', "field": "source", width: '15%'},
        {name: 'Last Update', "field": "updatedAt", width: '15%'},
...
function camsTrxnCtrl($scope, $http) {
    ...
    $scope.gridOptions.columnDefs = [
        ...
        {name: 'Price', "field": "PURPRICE"},
         {name: 'Amount', "field": "AMOUNT"},
        {name: 'Trade Date', "field": "TRADDATE"},
        {name: 'Folio', "field": "FOLIO_NO"},
        {name: 'Trxn Type', "field": "TRXN_TYPE_"},
        {name: 'UniqueNo', "field": "SEQ_NO"},
        {name: 'Status', "field": "processed"}
    ];
    $http({
        method: 'GET',
...
function karvyTrxnCtrl($scope, $http) {
    ...
    $scope.gridOptions.columnDefs = [
        ...
        {name: 'Units', "field": "TD_UNITS"},
        {name: 'Price', "field": "TD_NAV"},
        {name: 'Amount', "field": "TD_AMT"},
        {name: 'Trade Date', "field": "TD_TRDT"},
        {name: 'Folio', "field": "TD_ACNO"},
        {name: 'Trxn Type', "field": "TD_TRTYPE"},
        {name: 'UniqueNo', "field": "UNQNO"},
        {name: 'Status', "field": "processed"}
    ];
    $http({
        method: 'GET',
...
function franklinTrxnCtrl($scope, $http) {
    ...
    $scope.gridOptions.columnDefs = [
        ...
        {name: 'Pan', "field": "IT_PAN_NO1"},
        {name: 'Fund Name', "field": "SCHEME_NA1", width: '15%'},
        {name: 'Units', "field": "UNITS"},
        {name: 'Price', "field": "NAV"},
        {name: 'Amount', "field": "AMOUNT"},
        {name: 'Trade Date', "field": "TRXN_DATE"},
        {name: 'Folio', "field": "CUSTOMER_6"},
        {name: 'Trxn Type', "field": "TRXN_TYPE"},
        {name: 'UniqueNo', "field": "TRXN_ID"},
        {name: 'Status', "field": "processed"}
    ];
    $http({
        method: 'GET',
