...
function invstmntFinTaxCtrl($scope, $state, fintaxService,convertDigitsIntoWords) {
    ...
    $scope.$watch('finTaxInvestmentFormData.amount', function (val) {
        if (val && val > 0) {
    ...
    $scope.$watch('finTaxInvestmentFormData.amt', function (val) {
        if (val && val > 0) {
    ...
    $scope.$watch('finTaxInvestmentFormData.amountOther', function (val) {
        if (val && val > 0) {
...
function healthInsuranceCtrl($scope, $state, fintaxService,convertDigitsIntoWords) {
    ...
    $scope.submitHealthInsurance = function () {
        ...
        fintaxService.setHealthInsuranceInfo(healthInfo);
...
function otherInfoCtrl($scope, $state, fintaxService,convertDigitsIntoWords) {
    ...
    $scope.otherInfo = function () {
        ...
        fintaxService.setOtherInfo(otherInformation);
...
function housePropTaxCtrl($scope, $state, fintaxService,convertDigitsIntoWords) {
    ...
    $scope.init = function () {
        var basicInfo = fintaxService.getBasicInfo();
        $scope.housePropertyData.houseProp = basicInfo.houseProp;
