...
angular.module('finatwork').factory('fintaxFilingService', function ($http, $q) {
    ...
    var getFinTaxBankInfo = function () {
        console.log("FinTaxSvcFiling getFinTaxBankInfo");
        $http({
            method: 'GET',
    ...
    var getFinTaxPersonalInfo = function () {
        console.log("FinTaxSvcFiling getFinTaxBankInfo");
        $http({
            method: 'GET',
    ...
    var getFinTaxFiling = function () {
        console.log("FinTaxSvc getFinTaxFiling");
        $http({
            method: 'GET',
    ...
    service.initialiseFinTaxFiling = function () {
        console.log("fintaxsvc initialiseFinTaxFiling");
        if (!finTaxFilingInitialised) getFinTaxFiling();
    };
    service.reset = function () {
        console.log("fintaxsvc reset");
        _data = {};
    ...
    service.isfinTaxFilingInitialised = function () {
        return finTaxFilingInitialised;
    };
    ...
    service.setBasicInfo = function (data) {
        _data.basic = data;
        setFinTaxFiling("basic");
    };
    service.getPersonalInfo = function () {
        //if(isEmpty(_personal)) _personal = getFinTaxPersonalInfo();
        //return _personal;
        console.log("FinTaxSvc getBasicInfo");
        var dfd = $q.defer();
    ...
    service.getBankInfo = function () {
        // if(isEmpty(_bank)) _bank = getFinTaxBankInfo();
        // return _bank;
        console.log("FinTaxSvcFiling getBankInfo");
        var dfd = $q.defer();
        if (bankInitialised) {
            dfd.resolve(_bank);
        } else {
